...
function App() {
  ...
  */
  ...
  const handleSubmitBelep = (e) => {
    ...
    fetch('https://szemeszterinditas-szerver.vercel.app/', {
      method: 'POST',
  ...
  const handleSubmitSzakInditasa = (e) => {
    ...
    fetch('https://szemeszterinditas-szerver.vercel.app/', requestOptionsSzakInditasa)
    .then(response => {
      if (!response.ok) {
        throw new Error('response not ok');
      }
  ...
  const handleSubmitTargyImport = (e) => {
    ...
    fetch('https://szemeszterinditas-szerver.vercel.app/', requestOptionsTargyImport)
    .then(response => {
      if (!response.ok) {
        throw new Error('response not ok');
      }
